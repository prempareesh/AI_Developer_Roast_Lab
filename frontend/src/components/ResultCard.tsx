...
export default function ResultCard({ result }: { result: any }) {
    ...
    const handleDownload = async () => {
        ...
        try {
            ...
            link.download = `${profile?.username || 'developer'}-roast.png`;
    ...
    const handleCopy = () => {
        const text = `🔥 AI Developer Roast Lab - ${profile?.username || 'developer'}\n\nRoast:\n${roast}\n\nVerdict: ${result?.score?.verdict || ''}\n\nCheck yours at: ${typeof window !== 'undefined' ? window.location.href : ''}`;
                ...
                <div className="bg-[#F5F6F7] p-8 border-b border-[#E5E7EB] flex flex-col md:flex-row items-center gap-6">
                    ...
                    <div className="flex gap-4 text-sm text-[#6B7280] font-medium bg-white p-4 rounded-xl shadow-sm border border-[#E5E7EB]">
                        <div className="flex flex-col items-center">
                            <span className="text-[#111827] font-bold text-lg">{profile?.followers || 0}</span>
                            <span>Followers</span>
                        </div>
                        <div className="w-px bg-[#E5E7EB]" />
                        <div className="flex flex-col items-center">
                            <span className="text-[#111827] font-bold text-lg">{profile?.publicRepos || 0}</span>
                            <span>Repos</span>
                        </div>
                    </div>
                </div>
                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-[#F5F6F7] p-4 rounded-xl border border-[#E5E7EB] flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="font-bold text-xl">{stats?.totalStars || 0}</div>
                                ...
                                <div className="bg-[#F5F6F7] p-4 rounded-xl border border-[#E5E7EB] flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="font-bold text-xl">{stats?.totalForks || 0}</div>
